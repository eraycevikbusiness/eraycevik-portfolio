...
const translations = {
  ...
  en: {
    ...
    hero: {
      ...
      eyebrow2: "Full Stack",
      eyebrow3: ".NET & Web",
      sub: "19 years old, from Switzerland — started coding at 14 as a self-taught dev, now training at Galaxus and always building.",
      cta1: "See projects",
      cta2: "Get in touch",
      scroll: "scroll",
      meta: ["Zürich · CH", "since 2020", "v2026"],
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "As part of my apprenticeship at Galaxus I work on internal tools and learn how software is developed, tested and deployed at one of Switzerland's largest e-commerce companies.",
  ...
  tr: {
    ...
    hero: {
      ...
      eyebrow2: "Full Stack",
      eyebrow3: ".NET & Web",
      sub: "19 yaşında, İsviçre'den — 14 yaşında otodidakt olarak başladım, şimdi Galaxus'ta eğitim alıyorum ve sürekli üretiyorum.",
      cta1: "Projeleri gör",
      cta2: "İletişime geç",
      scroll: "kaydır",
    ...
    projects: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: "Galaxus'taki çıraklığım kapsamında dahili araçlar üzerinde çalışıyorum ve İsviçre'nin en büyük e-ticaret şirketlerinden birinde yazılımın nasıl geliştirildiğini öğreniyorum.",
